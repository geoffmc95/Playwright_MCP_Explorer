...
test_1.test.describe('Automation-testing-online-homepage - Exploration Test', () => {
    ...
    (0, test_1.test)('Page loads successfully with key elements', async ({ page }) => {
        ...
        await page.screenshot({
            path: 'screenshots/automation-testing-online-homepage-initial.png',
            fullPage: true
        });
    });
...
//# sourceMappingURL=automation-testing-online-homepage.spec.js.map