...
test_1.test.describe('Automation-testing-online-homepage-2 - Exploration Test', () => {
    ...
    (0, test_1.test)('Page loads successfully with key elements', async ({ page }) => {
        ...
        await page.screenshot({
            path: 'screenshots/automation-testing-online-homepage-2-initial.png',
            fullPage: true
        });
    });
...
//# sourceMappingURL=automation-testing-online-homepage-2.spec.js.map